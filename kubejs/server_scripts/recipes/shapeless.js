...
ServerEvents.recipes(event => {
  ...
  // Storage blocks
  event.shapeless('4x farmersdelight:wheat_dough', 'alexscaves:dough_block').id(`${RECIPE_PREFIX}dough_from_dough_block`);
  event.shapeless('9x minecraft:charcoal', 'thermal:charcoal_block').id(`${RECIPE_PREFIX}charcoal_from_charcoal_block`);
  event.shapeless('9x create:bar_of_chocolate', 'alexscaves:block_of_chocolate').id(`${RECIPE_PREFIX}chocolate_from_chocolate_block`);
