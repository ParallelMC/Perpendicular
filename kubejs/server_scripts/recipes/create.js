...
ServerEvents.recipes(event => {
    ...
    event.recipes.create.milling(['2x alexscaves:gingerbread_crumbs', Item.of('alexscaves:gingerbread_crumbs').withChance(0.5)], 'create_confectionery:gingerbread').id(`${MILLING_PREFIX}gingerbread_crumbs`);
})